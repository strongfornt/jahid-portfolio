...
const keywords = ["our", "reliable,", "solutions."];
const keywords2 =["has","game-changer","Their"];
const keywords3 =["in","solutions","invaluable"];
